...
Insert into FB_USER(user_id,FIRSTNAME,LASTNAME,YEAR_OF_BIRTH,MONTH_OF_BIRTH,DAY_OF_BIRTH,GENDER,hometown_ID,current_ID)
select distinct u.user_id, u.FIRST_NAME,u.LAST_NAME,u.YEAR_OF_BIRTH,u.MONTH_OF_BIRTH,u.DAY_OF_BIRTH,u.GENDER,l.loc_id , a.loc_id 
from new_user u, location l,location a 
where u.hometown_city = l.city AND u.hometown_state = l.state AND u.hometown_country = l.country AND u.current_city = a.city AND u.current_state = a.state AND u.current_country = a.country;
